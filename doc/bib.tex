...
\bibitem{jrbell} \url{http://home.claranet.nl/users/mhx/Forth_Bell.pdf}\\
\textbf{James R. Bell}
\emph{\textbf{Threaded Code}}
CACM Programming Techniques, June 1973, Volume 16, ACM Number 6

\bibitem{loeliger}
\href{http://sinclairql.speccy.org/archivo/docs/books/Threaded_interpretive_languages.pdf}{pdf}
\textbf{R.G.Loeliger}\\
\emph{\textbf{Threaded Interpretive Languages}\\Their Design and
Implementation}\\
Byte Books, Peterborough, NH 03458
